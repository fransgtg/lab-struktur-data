...
void dijkstra(int V, vector<vector<iPair>> &adj, int src) {
    ...
    while (!pq.empty()) {
        ...
        //Jika yang diambil bukan yang terkecil, skip
        ...
        // Periksa semua tetangga dari simpul yang diambil
        for (auto &neighbor : adj[u]) {
            int v = neighbor.first;
            int weight = neighbor.second;

            // Jika jarak baru lebih pendek, perbarui jarak dan masukkan ke dalam antrian
